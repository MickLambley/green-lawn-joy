      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <Label htmlFor="base-address">
            What is your base address? <span className="text-destructive">*</span>
          </Label>
          <p className="text-sm text-muted-foreground">
            This is where you'll travel from to reach jobs. It could be your home or business address.
          </p>
